                ...
                <div class="card radius-10 border-0 border-start border-primary border-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="">
                                <p class="mb-1">Total des articles</p>
                                <h4 class="mb-0 text-primary">{{ $total_articles }}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="">
                                ...
                                <h4 class="mb-0 text-success">{{ $total_projets }}</h4>
                            </div>
            ...
            <div class="col">
                <div class="card radius-10 border-0 border-start border-danger border-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="">
                                <p class="mb-1">Total des étages</p>
                                <h4 class="mb-0 text-danger">{{ $total_etages }}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="team-list">
                            <div class="d-flex align-items-center gap-3">
                                <div class="">
                                    <img src="/admin/images/avatars/01.png" alt="" width="50"
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="">
                                    <img src="/admin/images/avatars/02.png" alt="" width="50"
                                        height="50" class="rounded-circle">
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-bold">Samantha Ivy</h6>
                                    <span
                                        class="badge bg-danger-subtle text-danger border border-opacity-25 border-danger">IN
                                        MEETING</span>
                                </div>
                                <div class="">
                                    <button class="btn btn-outline-primary rounded-5 btn-sm px-3">Add</button>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="">
                                    <img src="/admin/images/avatars/03.png" alt="" width="50"
                                        height="50" class="rounded-circle">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="">
                                    <img src="/admin/images/avatars/04.png" alt="" width="50"
                                        height="50" class="rounded-circle">
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-bold">Alex Smith</h6>
                        ...
                        <div class="team-list">
                            <div
                                ...
                                <div class="form-check form-switch form-check-success border-0">
                                    <input class="form-check-input border-1" type="checkbox" role="switch"
                                        checked="">
                                </div>
                            </div>
                            <hr>
                        ...
                        <div class="team-list">
                            <div class="d-flex align-items-center gap-3">
                                <div class="widget-icon bg-transparent border rounded-3">
                                    <img src="/admin/images/icons/apple.png" alt="" width="30">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="widget-icon bg-transparent border rounded-3">
                                    <img src="/admin/images/icons/bootstrap.png" alt="" width="30">
                                </div>
                                <div class="flex-grow-1">
                                    <p class="mb-2 fw-bold">Angular 12 Dashboard</p>
                                    <div class="progress" style="height: 5px;">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="widget-icon bg-transparent border rounded-3">
                                    <img src="/admin/images/icons/google-2.png" alt="" width="30">
                                </div>
                                <div class="flex-grow-1">
                                    <p class="mb-2 fw-bold">Angular 12 Dashboard</p>
                                    <div class="progress" style="height: 5px;">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="widget-icon bg-transparent border rounded-3">
                                    <img src="/admin/images/icons/spotify.png" alt="" width="30">
                                </div>
                                <div class="flex-grow-1">
                                    <p class="mb-2 fw-bold">Angular 12 Dashboard</p>
                                    <div class="progress" style="height: 5px;">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="widget-icon bg-transparent border rounded-3">
                                    <img src="/admin/images/icons/outlook.png" alt="" width="30">
                                </div>
                                <div class="flex-grow-1">
                                    <p class="mb-2 fw-bold">Angular 12 Dashboard</p>
                                    <div class="progress" style="height: 5px;">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                                            <div class="customer-pic">
                                                <img src="/admin/images/avatars/01.png" class="rounded-circle"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                                            <div class="customer-pic">
                                                <img src="/admin/images/avatars/02.png" class="rounded-circle"
                                                    width="40" height="40" alt="">
                                            </div>
                                            <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                                            <div class="customer-pic">
                                                <img src="/admin/images/avatars/03.png" class="rounded-circle"
                                                    width="40" height="40" alt="">
                                            </div>
                                            <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                                            <div class="customer-pic">
                                                <img src="/admin/images/avatars/04.png" class="rounded-circle"
                                                    width="40" height="40" alt="">
                                            </div>
                                            <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                                            <div class="customer-pic">
                                                <img src="/admin/images/avatars/05.png" class="rounded-circle"
                                                    width="40" height="40" alt="">
                                            </div>
                                            <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                                            <div class="customer-pic">
                                                <img src="/admin/images/avatars/06.png" class="rounded-circle"
                                                    width="40" height="40" alt="">
                                            </div>
                                            <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                                            <div class="customer-pic">
                                                <img src="/admin/images/avatars/07.png" class="rounded-circle"
                                                    width="40" height="40" alt="">
                                            </div>
                                            <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                                        </a>
